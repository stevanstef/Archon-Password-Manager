...
from security import derive_key, generate_password
from vault import (
    VaultError,
    decrypt_entries,
    load_vault_file,
...
class PasswordManagerApp:
    ...
    def _refresh_listbox(self):
        ...
        for index, entry in enumerate(
            ...
            # Search intentionally filters by TITLE only.
